...
public class IntroToEncapsulation {
	...
	public static void main(String[] args) {
		...
		System.out.println("Fuel tank capacity"+fuelTankCapacity+", fuel in tank :"+fuelInTank+", miles per gallon: "+mpg+", color :"+color);
